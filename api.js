...
/* ---------- 4. DATA DEMO ---------- */
window.NAVERO_DEMO = [
  { id:"001", name:"Blender Mini Portable USB", category:"Rumah Tangga", price:"79000",  image:"https://picsum.photos/seed/blender/600/600", link:"https://shopee.co.id/", description:"Blender praktis untuk jus & smoothie, muat dibawa bepergian.", badge:"TERLARIS", video:"" },
  { id:"002", name:"TWS Earbuds Bluetooth 5.3",  category:"Elektronik",  price:"149000", image:"https://picsum.photos/seed/earbuds/600/600", link:"https://shopee.co.id/", description:"Suara jernih, bass mantap, baterai tahan hingga 24 jam.", badge:"PROMO", video:"" },
  { id:"003", name:"Lampu Meja LED Sentuh",      category:"Rumah Tangga", price:"65000",  image:"https://picsum.photos/seed/lampu/600/600",   link:"https://shopee.co.id/", description:"3 mode cahaya, hemat energi, desain minimalis modern.", badge:"BARU", video:"" },
  { id:"004", name:"Keyboard Mechanical 60%",    category:"Gaming",      price:"299000", image:"https://picsum.photos/seed/keyboard/600/600", link:"https://shopee.co.id/", description:"Switch biru, RGB backlight, anti-ghosting untuk gaming.", badge:"FAVORIT", video:"" },
  { id:"005", name:"Serum Vitamin C Glow",       category:"Kecantikan",  price:"89000",  image:"https://picsum.photos/seed/serum/600/600",   link:"https://shopee.co.id/", description:"Mencerahkan kulit & menyamarkan noda hitam dalam 2 minggu.", badge:"TERLARIS", video:"" },
  { id:"006", name:"Kaos Oversize Cotton Combed", category:"Fashion",    price:"55000",  image:"https://picsum.photos/seed/kaos/600/600",    link:"https://shopee.co.id/", description:"Bahan adem 24s, jahitan rapi, cocok untuk daily outfit.", badge:"BARU", video:"" },
  { id:"007", name:"Smartwatch T900 Ultra",      category:"Aksesoris",   price:"189000", image:"https://picsum.photos/seed/watch/600/600",   link:"https://shopee.co.id/", description:"Layar AMOLED, monitor detak jantung, tahan air IP67.", badge:"PROMO", video:"" },
  { id:"008", name:"Powerbank 20000mAh Fast Charge", category:"Elektronik", price:"175000", image:"https://picsum.photos/seed/powerbank/600/600", link:"https://shopee.co.id/", description:"Dual output 22.5W, bisa isi 3 device sekaligus.", badge:"TERLARIS", video:"" },
  { id:"009", name:"Rak Dinding Multifungsi",    category:"Rumah Tangga", price:"45000",  image:"https://picsum.photos/seed/rak/600/600",     link:"https://shopee.co.id/", description:"Tanpa bor, kuat menahan hingga 5kg, hemat ruang.", badge:"FAVORIT", video:"" },
  { id:"010", name:"Mouse Gaming RGB 7200 DPI",  category:"Gaming",      price:"125000", image:"https://picsum.photos/seed/mouse/600/600",   link:"https://shopee.co.id/", description:"Sensor presisi tinggi, 6 tombol programmable, ringan.", badge:"BARU", video:"" },
  { id:"011", name:"Kopi Latte Sachet Premium",  category:"Makanan",     price:"38000",  image:"https://picsum.photos/seed/kopi/600/600",    link:"https://shopee.co.id/", description:"Rasa creamy ala kafe, cukup seduh 1 menit.", badge:"PROMO", video:"" },
  { id:"012", name:"Tas Ransel Anti Air 25L",    category:"Aksesoris",   price:"139000", image:"https://picsum.photos/seed/tas/600/600",     link:"https://shopee.co.id/", description:"Bahan polyester premium, banyak kompartemen, USB port.", badge:"FAVORIT", video:"" },
];
 ...
 * @returns {{ type: 'youtube'|'drive'|'mp4'|'none', id?: string, embed?: string, src?: string }}
 */
function detectVideoType(url) {
  ...
  // Video file (.mp4, .webm, .ogg, .mov, .m4v)
